                              ...
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: SearchField(
                                    ...
                                    searchInputDecoration: theme_helper()
                                        .text_form_style(
                                            "The sender's name",
                                      ...
                                      setState(() {
                                        ...
                                        final filter =
                                          ...
                                          return element['userName']
                                              .toLowerCase()
                                              .startsWith(selectedSenderName
                                                  .toLowerCase());
                                        }).toList();
                                        send_name = filter[0]['Fname'] +
                                            " " +
                                            filter[0]['Lname'];
                                        send_phone = "0" +
                                            filter[0]['phoneNumber'].toString();
                                    ...
                                    onSuggestionTap:
                                      ...
                                      setState(() {
                                        ...
                                        final filter =
                                          ...
                                          return element['userName']
                                              .toLowerCase()
                                              .startsWith(selectedRecName
                                                  .toLowerCase());
                                        }).toList();
                                        rec_name = filter[0]['Fname'] +
                                            " " +
                                            filter[0]['Lname'];
                                        rec_phone = "0" +
                                            filter[0]['phoneNumber'].toString();
